...
$pvalc=8; # col index for pvalue
$chrc=1; # col index for chr
$posc=2; # col index for pos-hg19 
$weic=6; # col index for effect size 
...
$weightfile = "/dcs04/lieber/statsgen/shizhong/database/GWAS/PGC/BP2024/gwas_hg38/bip2024_eur_no23andMe_hg38";
if($weightfile =~ /\.gz$/){
