...
writeLines(c(
  ...
  "uses matching v7.0 association and annotation releases with the verified",
  "annotation-position correction, but has not received the paper's final",
  "HRC-based DENTIST filter.",
  "",
  "## Validation",
  "",
